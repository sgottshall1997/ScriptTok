          ...
          <table className="min-w-full divide-y divide-neutral-200">
            <thead className="bg-neutral-50">
              <tr>
                ...
                <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-neutral-500 uppercase tracking-wider">Niche</th>
                  ...
                  <tr key={generation.id}>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-neutral-600">
                      <span className="px-2 py-1 text-xs rounded-full bg-teal-100 text-teal-800">
                        {generation.niche.charAt(0).toUpperCase() + generation.niche.slice(1)}
                      </span>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-neutral-600">
