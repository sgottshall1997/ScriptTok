...
import { getFeatureFlagWarning } from '../utils/featureFlags';
...
interface InstructionFooterProps {
  ...
  envKeys?: string[];
  notes?: string[];
  featureFlags?: string[]; // Features this page depends on
}

const InstructionFooter: React.FC<InstructionFooterProps> = ({
  title,
  whatIsIt,
  setupSteps,
  usageSteps,
  ...
  const featureFlagWarning = getFeatureFlagWarning(featureFlags);
        ...
        <CardContent className="space-y-6">
          ...
          <div className="pt-4 border-t border-blue-200 dark:border-blue-800">
            <p className="text-xs text-blue-700 dark:text-blue-300 text-center">
              <strong>{title}</strong> • Part of the CookAIng Marketing Engine • For Spence's Reference
            </p>
          </div>
        </CardContent>
      </Card>
