        ...
        <div className="text-center space-y-4">
          ...
          <div className="space-y-2">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Accessibility, AI transparency, safety guidelines, and community standards for Pheme
            </p>
          ...
          <CardContent className="space-y-6">
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
                  <h4 className="font-semibold text-blue-800 dark:text-blue-200 mb-2">Visual Accessibility</h4>
                ...
                <div className="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg p-4">
                  <h4 className="font-semibold text-green-800 dark:text-green-200 mb-2">Navigation & Interaction</h4>
            ...
            <div>
              ...
              <p className="text-gray-700">
                If you encounter accessibility barriers while using Pheme, please contact us at 
          ...
          <CardContent className="space-y-6">
            <div className="bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-lg p-4">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h4 className="font-semibold text-yellow-800 dark:text-yellow-200 mb-2">Important AI Content Disclosure</h4>
                  <p className="text-sm text-yellow-700 dark:text-yellow-300">
                    ⚠️ <strong>AI-generated content outputs are probabilistic and not guaranteed to go viral</strong> 
                    or achieve specific engagement rates. All content generated by Pheme uses artificial intelligence 
            ...
            <div>
              ...
              <div className="space-y-3">
                <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg p-4">
                  <h4 className="font-semibold text-red-800 dark:text-red-200 mb-2">No Guarantees</h4>
                ...
                <div className="bg-purple-50 dark:bg-purple-900/20 border border-purple-200 dark:border-purple-800 rounded-lg p-4">
                  <h4 className="font-semibold text-purple-800 dark:text-purple-200 mb-2">Human Review Required</h4>
                ...
                <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
                  <h4 className="font-semibold text-blue-800 dark:text-blue-200 mb-2">Originality Considerations</h4>
        ...
        <Card>
          ...
          <CardContent className="space-y-6">
            <div>
              ...
              <p className="text-gray-700 mb-4">
                Pheme has specific age requirements to ensure compliance with privacy laws and create 
                an appropriate environment for content creation:
              </p>
              
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg p-4">
                  <h4 className="font-semibold text-red-800 dark:text-red-200 mb-2">Under 13 Years Old</h4>
                  <p className="text-sm text-red-700 dark:text-red-300">
                    <strong>Not Permitted:</strong> Pheme is not intended for children under 13. 
                    We do not knowingly collect information from children under 13.
                  </p>
                </div>
                <div className="bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-lg p-4">
                  <h4 className="font-semibold text-yellow-800 dark:text-yellow-200 mb-2">13-17 Years Old</h4>
                  <p className="text-sm text-yellow-700 dark:text-yellow-300">
                    <strong>Parental Consent Required:</strong> Users between 13-17 should obtain 
                    parental consent before using Pheme.
                  </p>
                </div>
              </div>
            </div>
        ...
        <Card>
          ...
          <CardContent className="space-y-6">
            <div>
              ...
              <p className="text-gray-700 mb-4">
                Pheme supports healthy digital habits and responsible content creation:
              </p>
            </div>
        ...
        <Card>
          ...
          <CardContent className="space-y-6">
            <div>
              ...
              <p className="text-gray-700 mb-4">
                Pheme users are expected to contribute to a positive, inclusive environment that 
