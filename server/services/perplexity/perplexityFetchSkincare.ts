...
export async function fetchTrendingSkincareProducts(): Promise<any[]> {
  ...
  const prompt = `You are a product research API. Return 3 trending skincare products from Amazon that are viral on TikTok or Instagram as of ${currentMonth} ${currentYear}. Respond ONLY with a JSON array and nothing else. Follow this structure exactly:
...
[
  { "product": "Hyaluronic Acid Serum 1oz", "brand": "The INKEY List", "mentions": 1650000, "reason": "Anti-aging routine viral trend" },
  { "product": "Foaming Facial Cleanser 12oz", "brand": "CeraVe", "mentions": 1200000, "reason": "Dermatologist recommended on TikTok" },
  { "product": "Vitamin C Brightening Serum", "brand": "Mad Hippie", "mentions": 890000, "reason": "Morning glow routine trend" }
]

Requirements:
- Real skincare products only (serums, cleansers, moisturizers, treatments)
- Specific brand names (CeraVe, The Ordinary, Fenty Beauty, etc.)
...
JSON array only:`;
  ...
  try {
    ...
    console.log(`✅ Skincare fetcher: Found ${validProducts.length} valid products`);
