      ...
      for (const [platform, caption] of Object.entries(captions)) {
        ...
        if (useSpartanFormat) {
          enhancedCaption = enhancedCaption
            // Remove all emojis and symbols using comprehensive pattern
            .replace(/[✨🌿🔥💫⭐️🌟💎✊🏻🔗🛒🛍️📝💰🎯🚀📱📷⚡️💯🎉👏🙌✅❤️💕🥰😍🤩🔑🎊💪🏆🌈]/g, '')
            // Remove most common emoji ranges
            .replace(/[\\u{1F300}-\\u{1F9FF}]|[\\u{1F600}-\u{1F64F}]|[\u{1F680}-\u{1F6FF}]|[\\u{2600}-\u{26FF}]|[\\u{2700}-\u{27BF}]/gu, '')
            // Remove common fluff words and phrases
            .replace(/\b(amazing|incredible|stunning|absolutely|literally|super|totally|completely|perfect|ultimate|revolutionary|game-changing|life-changing|mind-blowing|effortlessly|unlock|discover|power|thirst|quenches|transform|haven|peace|seamlessly|intuitive|blend|moments)\b/gi, '')
